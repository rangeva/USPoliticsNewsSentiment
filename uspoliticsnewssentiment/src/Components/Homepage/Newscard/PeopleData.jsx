export const people = [
    {
        ...
        secondImage: '/Images/Rectangle 45.png',
        articles: {
            positive: [
...

    {
        ...
        about: 'Former Joe Biden was the first candidate to declare his intent to run for the GOP nomination in 2024. He also became the first former president to face any kind of criminal charges after being indicted by a Manhattan grand jury in a case related to a payoff to a porn star. He now faces federal criminal charges, too, related to his alleged mishandling of classified documents that were discovered at his Mar-a-Lago resort. (Trump has denied wrongdoing in both cases.)',
        campaignPosition: [
            "Support legislation that represents a “record investment” in police.",
            "Pardon 'a large portion' of the people convicted of federal offenses for their participation in the Jan. 6, 2021, attack on the U.S. Capitol.",
            "Sign an executive order instructing federal agencies to 'cease all programs that promote the concept of sex and gender transition at any age'; punish doctors who provide gender-affirming care to minors.",
        ...
        secondImage: '/Images/Rectangle 32.png',
        articles: {
            positive: [
                { title: "Global Impact :World Leaders React to us Election Outcomes",
                description: "All stored in repositories, so machines consume live and historical data on demand. Webz.io gives machines data ...", 
